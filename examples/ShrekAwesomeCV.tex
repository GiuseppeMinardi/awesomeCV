...
\begin{document}
% Ogre-themed colors
\definecolor{cvnamecolor}{HTML}{4A7023}  % Deep swamp green
\definecolor{cvsectioncolor}{HTML}{8B4513}  % Muddy brown
\definecolor{cvtitlecolor}{HTML}{2F4F2F}  % Dark forest green
\definecolor{cvrulecolor}{HTML}{6B4423}  % Earthy brown
\definecolor{cvdurationcolor}{HTML}{6B4423}  % Matching earthy brown
\definecolor{cvpublicationcolor}{HTML}{4A7023}  % Matching swamp green
